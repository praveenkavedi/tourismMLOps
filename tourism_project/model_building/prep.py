...
DATASET_REPO_ID = "Praveen-kavedi/Tourism-Customer-prediction"
DATASET_FILENAME = "tourism.csv"

# Download the main dataset to a local path before reading with pandas
local_tourism_dataset_path = hf_hub_download(
    repo_id=DATASET_REPO_ID,
    filename=DATASET_FILENAME,
    repo_type="dataset"
)
tourism_dataset = pd.read_csv(local_tourism_dataset_path)
