...
Xtrain_path = "hf://datasets/Praveen-kavedi/Tourism-Customer-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/Praveen-kavedi/Tourism-Customer-prediction/Xtest.csv"
ytrain_path = "hf://datasets/Praveen-kavedi/Tourism-Customer-prediction/ytrain.csv"
ytest_path = "hf://datasets/Praveen-kavedi/Tourism-Customer-prediction/ytest.csv"
...
param_grid = {
    ...
    'xgbclassifier__colsample_bytree': [0.4, 0.5, 0.6],         # percentage of attributes per tree
    'xgbclassifier__colsample_bylevel': [0.4, 0.5, 0.6],        # percentage of attributes per level
...
with mlflow.start_run():
    ...
    repo_id = "Praveen-kavedi/Tourism-Customer-prediction"
    repo_type = "model"
